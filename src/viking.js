...
function Soldier(health,strength) {
    ...
    War.prototype.vikingAttack=function(){
        ...
        //s= the saxon who has been chosen reandomly
        let v=this.vikingArmy[vI];
        //v= the viking who has been chosen reandomly
        fightResults= s.receiveDamage(v.strength);
        if (s.health<=0){
    ...
    War.prototype.saxonAttack=function(){
        ...
        let s=this.saxonArmy[sI];
        let v=this.vikingArmy[vI];
        fightResults=v.receiveDamage(s.strength);
